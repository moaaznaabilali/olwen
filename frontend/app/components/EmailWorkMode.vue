...
.work__bg { position: absolute; inset: 0; z-index: -1; background: radial-gradient(ellipse at 70% 45%, var(--bg) 0%, var(--bg) 70%); }
...
.work__status { position: absolute; bottom: 0%; display: inline-flex; align-items: center; gap: 8px; max-width: 90%; font-family: 'JetBrains Mono', monospace; font-size: 10px; letter-spacing: 1.4px; text-transform: uppercase; color: var(--accent-2); white-space: nowrap; }
...
.card { border-radius: 14px; padding: 14px 16px; border: 0.5px solid var(--border); border-left: 3px solid var(--p); background: var(--surface-2); backdrop-filter: blur(12px); transition: opacity .4s ease, box-shadow .4s ease, border-color .4s ease; }
...
.card__from { font-size: 13px; color: var(--text-strong); font-weight: 500; }
.card__prio { font-family: 'JetBrains Mono', monospace; font-size: 8px; letter-spacing: 1.2px; }
.card__start { font-family: 'JetBrains Mono', monospace; font-size: 8px; letter-spacing: 1px; text-transform: uppercase; color: var(--bg); background: var(--accent); border-radius: 999px; padding: 2px 8px; }
.card__subj { margin: 5px 0 0; font-size: 14.5px; font-weight: 300; color: var(--text-strong); line-height: 1.3; }
.card__snip { margin: 5px 0 0; font-size: 11.5px; color: var(--text-muted); line-height: 1.4; }
.card__sug { margin: 8px 0 0; font-size: 12.5px; line-height: 1.5; color: var(--accent-2); display: flex; gap: 6px; }
...
.summary__task { font-size: 17px; font-weight: 300; color: var(--text-strong); max-width: 560px; }
